...
class s {
    advance(t) {
        ...
        var o, n, l, r, h, a, c;
        null == (e = this.onUpdate) || e.call(this, this.value, s),
        s && this.stop()
    }
    stop() {
        this.isRunning = !1
...
class o {
    constructor({wrapper: t, content: i, autoResize: s=!0, debounce: o=250}={}) {
        e(this, "resize", ()=>{
            this.onWrapperResize(),
            this.onContentResize()
        }
        ),
        e(this, "onWrapperResize", ()=>{
        ...
        this.wrapper = t,
        this.content = i,
        s && (this.debouncedResize = function(t, e) {
            let i;
            return function() {
                let s = arguments
                  , o = this;
...
class h {
    constructor({wrapper: t=window, content: e=document.documentElement, wheelEventsTarget: i=t, eventsTarget: l=i, smoothWheel: h=!0, syncTouch: a=!1, syncTouchLerp: c=.075, touchInertiaMultiplier: d=35, duration: p, easing: u=t=>Math.min(1, 1.001 - Math.pow(2, -10 * t)), lerp: m=!p && .1, infinite: v=!1, orientation: g="vertical", gestureOrientation: w="vertical", touchMultiplier: S=1, wheelMultiplier: f=1, autoResize: _=!0, __experimental__naiveDimensions: y=!1}={}) {
        this.__isSmooth = !1,
        ...
        this.onVirtualScroll = ({deltaX: t, deltaY: e, event: i})=>{
            ...
            if (r = r.slice(0, r.indexOf(this.rootElement)),
            r.find(t=>{
                var e, i, n, l, r;
            ...
            this.scrollTo(this.targetScroll + h, Object.assign({
                programmatic: !1
            }, a ? {
    ...
    scrollTo(t, {offset: e=0, immediate: s=!1, lock: o=!1, duration: n=this.options.duration, easing: l=this.options.easing, lerp: r=!n && this.options.lerp, onComplete: h, force: a=!1, programmatic: c=!0}={}) {
        if (!this.isStopped && !this.isLocked || a) {
            ...
            if ("number" == typeof t) {
                if (t += e,
                t = Math.round(t),
                this.options.infinite ? c && (this.targetScroll = this.animatedScroll = this.scroll) : t = i(0, t, this.limit),
                s)
